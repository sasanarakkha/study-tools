...
def main():
    parser = argparse.ArgumentParser(
        description="Compare current .md files with an older version using word sequence logic."
    )
    parser.add_argument(
        "--commit", default="724b516b", help="Git commit to compare against"
    )
    parser.add_argument(
        "--dir", default="docs/6-pali-class", help="Directory to search for .md files"
    )
    parser.add_argument(
        "--verbose", action="store_true", help="Show the actual differences found"
    )
