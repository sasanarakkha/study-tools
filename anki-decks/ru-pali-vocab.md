...
Если у вас возникают проблемы с обновлением вашей колоды, попробуйте установить [Special fields Add-on](https://sasanarakkha.github.io/study-tools/anki-decks/special-fields.html). Устанавливайте его только в том случае, если вы исчерпали все другие варианты.
