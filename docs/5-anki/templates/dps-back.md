...
<table>
    ...
    <tr valign="top">
        <td class="another_color">Русский:</td>
        <td>{{ru_meaning}}{{#ru_meaning_lit}}; досл. {{ru_meaning_lit}}{{/ru_meaning_lit}}</td>
    </tr>
    ...
    <tr valign="top">
        ...
        <td>{{root}}{{root_has_verb}}{{root_group}} {{root_sign}} ({{root_meaning}} - {{root_ru_meaning}})</td>
    </tr>
    {{/root}}
    ...
    <tr valign="top">
        ...
        <td class="small">{{sanskrit}} {{#sanskrit_root}} {{sanskrit_root}} {{sanskrit_root_class}} ({{sanskrit_root_meaning}} - {{sanskrit_root_ru_meaning}}){{/sanskrit_root}} </td>
    </tr>
    {{/sanskrit}}
    ...
    {{#ru_notes}}
    <tr valign="top">
        <td class="another_color">Заметки:</td>
        <td class="small">{{ru_notes}}</td>
    </tr>
    {{/ru_notes}}
