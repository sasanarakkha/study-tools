...
| anupasampannaṃ | noun | masc acc sg of anupasampannaṃ | | unordained person | not accomplished | √pad (go, step) | | na + upa + saṃ + √pad + na | | |
| padaso | ind | adv, abl sg of pada | | line by line | from step | √pad (go, step) | | √pad + a + so | | |
| dhammaṃ | noun | masc acc sg of dhamma | | teaching, doctrine | | √dhar (hold) | | √dhar + ma | | |
| vāceyya | verb | opt 3rd sg of vāceti | | he would cause to recite | | √vac (speak) | √vac + *e > vāce | vāce + ti | | |
